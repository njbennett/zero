defmodule ZeroWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {ZeroWeb.Layouts, :root}
  ...
  # scope "/api", ZeroWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:zero, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ZeroWeb.Telemetry
